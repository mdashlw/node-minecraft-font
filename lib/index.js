  ...
  for (let index = 0; index < text.length; index++) {
    ...
    if (char === "§") {
      ...
      if (!glyph.empty) {
        ...
        console.log(color.toString(16).padStart(2, "0"));
        glyph.render(context, x + shadowOffset, y + shadowOffset, (color * (63 / 255)).toString(16).padStart(6, "0"));
        glyph.render(context, x, y, color.toString(16).padStart(6, "0"));
      }
